...
//Complementario buscar sort
const mayorCantidadDePlataformas = listaDePeliculas.filter(pelicula => pelicula.plataforma.length < 100);
console.log(mayorCantidadDePlataformas)